...
<translocators:translocator_part>.addTooltip(format.red("For people playing on servers, it is advised that you use/replace translocators with Tesslocators for improved performance."));
